package br.com.gerenciadorclientesjava.config;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("br.com.gerenciadorclientesjava.apis"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("gerenciador-clientes-java")
